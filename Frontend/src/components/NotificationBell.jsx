  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        className="relative rounded-xl p-2 text-text-muted hover:bg-surface-muted"
      >
            ...
            {isLoading ? (
              ...
              notifications.map((n) => (
                <div key={n._id} className="border-b border-border px-4 py-3 last:border-0">
                  ...
                  <p className="mt-1 text-[11px] text-text-muted">{formatDate(n.createdAt, { day: "numeric", month: "short", hour: "numeric", minute: "2-digit" })}</p>
                </div>
              ))
            )}
          </div>
